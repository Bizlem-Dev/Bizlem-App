...
//		System.out.println("http://prod.bizlem.io:8082/portal/servlet/service/news.schedularcall?urlid=" + jobDetail.getJobDataMap().getString("example"));
			this.callGetService("http://prod.bizlem.io:8082/portal/servlet/service/news.schedularcall?node=sourcemaster&urlid="+jobDetail.getJobDataMap().getString("example"), null, null);
